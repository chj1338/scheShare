...
public class EngHanNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eng_han_new);
...
//                textView2.setTextSize(TypedValue.COMPLEX_UNIT_PX, fontSize);
    ...
    public void readConfig(Spinner spinner1, Spinner spinner2) {
        try {
            ...
            while ((line = br.readLine()) != null) {
                //Toast.makeText(EngHanNewActivity.this, "2 : " + line, Toast.LENGTH_SHORT).show();
    ...
    public void readBookHan(View v, Spinner spinner1, Spinner spinner2, ScrollView scrollView1, TableLayout tableLayout) {
        // last page item (한글)
        ArrayAdapter adapter_ac_name_kor = ArrayAdapter.createFromResource(this, R.array.bible_new_name_kor_ac, android.R.layout.simple_spinner_item);
        ArrayAdapter adapter_ac_name_eng = ArrayAdapter.createFromResource(this, R.array.bible_new_name_eng_ac, android.R.layout.simple_spinner_item);
        ...
        try {
            //raw 폴더 읽기
            InputStream is_kor = getResources().openRawResource(R.raw.bible_new);
            BufferedReader br_kor = new BufferedReader(new InputStreamReader(is_kor));

            //raw 폴더 읽기(영문)
            InputStream is_eng = getResources().openRawResource(R.raw.bible_eng_niv_new);
            ...
            e.printStackTrace();
            Toast.makeText(EngHanNewActivity.this, "파일을 찾을 수 없습니다.", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            Toast.makeText(EngHanNewActivity.this, "저장되었습니다.", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
