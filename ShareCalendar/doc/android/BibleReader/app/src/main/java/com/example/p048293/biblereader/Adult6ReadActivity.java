...
public class Adult6ReadActivity extends AppCompatActivity {
    int nowYear = 0;    // 올해
    int nowMon = 0;     // 당월
    int nowDate = 0;    // 오늘
    int nowDay = 0;     // 오늘 요일
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult_6_read);
...
//                    dayTtext[tr][td].setMinHeight(280);
                    ...
                    dayTtext[tr][td].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent = new Intent(Adult6ReadActivity.this, Adult6TestamemtActivity.class);
