...
public class KinderReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kinder_read);
    ...
    public void makeCalendar(TableLayout tableLayout1, TextView calText) {
        ...
        try {
            String line = "";
            BufferedReader br = new BufferedReader(new FileReader(getFilesDir() + "/kinderReadHist_" + nowYear + ".txt"));
        ...
        for(int tr=0; tr<trCt; tr++) {
            ...
            for(int td = 0; td < tdCt; td++) {
                ...
                if(tr == 0) {   // 요일 셋팅
                    ...
                    try {
                        String line = "";
                        InputStream is = getResources().openRawResource(R.raw.kinder_read_list);
...
//                    dayTtext[tr][td].setMinHeight(280);
                    ...
                    dayTtext[tr][td].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            try {
                                String configFile = "/kinderRead.txt";
                            ...
                            Intent intent = new Intent(KinderReadActivity.this, KinderTestamemtActivity.class);
