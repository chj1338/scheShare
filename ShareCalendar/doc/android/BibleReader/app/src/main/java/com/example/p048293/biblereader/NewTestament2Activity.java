...
public class NewTestament2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_testament2);
...
//        final TextView textView = (TextView)findViewById(R.id.textView001);
        ...
        btnAutoScroll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                scrollDist = listView.getMeasuredHeight();
                scrollTime =  listView.getMeasuredHeight() * 145000 / 7139;   // 최초 기준값 - 길이:3719, 시간:145000
...
//                ((TextView) parent.getChildAt(0)).setTextColor(Color.BLUE);
                ...
                setLastPage(spinner1, spinner2);
                nowPage = 0;
                readBook(view, spinner1, spinner2, listView);
...
//                Toast.makeText(NewTestamentActivity.this, "현재크기 : " + fontSize, Toast.LENGTH_LONG).show();
                ...
                readBook(v, spinner1, spinner2, listView);
...
//                textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, fontSize);
            ...
            public void onClick(View v) {
                ...
                if(position > 0) {
                    ...
                    if(spinner1.getSelectedItemPosition() == 0) {
                        Toast.makeText(NewTestament2Activity.this, "맨 처음 입니다.", Toast.LENGTH_SHORT).show();
                    } else {
                        int sp1Position = spinner1.getSelectedItemPosition() - 1;

                        // last page item
                        ArrayAdapter adapter_page = ArrayAdapter.createFromResource (NewTestament2Activity.this, R.array.bible_new_page, android.R.layout.simple_spinner_item);
            ...
            public void onClick(View v) {
                ...
                if(position < lastPosition) {
                    ...
                    if(spinner1.getSelectedItemPosition() == 38) {
                        Toast.makeText(NewTestament2Activity.this, "마지막 입니다.", Toast.LENGTH_SHORT).show();
                    } else {
        ...
        btnReadHist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter adapter = ArrayAdapter.createFromResource(NewTestament2Activity.this, R.array.bible_new_name_kor_ac, android.R.layout.simple_spinner_item);
                ...
                try {
                    ...
                    Toast.makeText(NewTestament2Activity.this, chaSu + "차 완독 저장했습니다.", Toast.LENGTH_SHORT).show();
    ...
    // book index 조합으로 찾기
    public void readBook(View v, Spinner spinner1, Spinner spinner2, ListView listView) {
        ...
        try {
            ...
            ArrayAdapter adapterList = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_multiple_choice, items);
...
/*
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            Toast.makeText(NewTestament2Activity.this, "저장되었습니다.", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
